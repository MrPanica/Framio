...
"""
    ,
        ...
        "action_passthrough_tip": "Неосязаемая рамка: клики сквозь выделение в фоновые окна (вкл/выкл)",
        ...
        "popup_gif_opt_max": 'Максимальное сжатие (64 цвета, малый вес)',
        "popup_gif_opt_high": 'Высокое сжатие (64 цвета, bayer)',
        "popup_gif_opt_balance": 'Баланс (128 цветов, сжатый)',
        "popup_gif_opt_quality": 'Высокое качество (256 цветов)',
        "popup_gif_opt_extreme": 'Экстремальное сжатие (32 цвета, микро-размер)',
...
,
        ...
        "action_passthrough_tip": "Pass-through frame: clicks pass through selection into background apps (on/off)",
        ...
        "popup_gif_opt_max": 'Maximum compression (64 colors, small size)',
        "popup_gif_opt_high": 'High compression (64 colors, bayer)',
        "popup_gif_opt_balance": 'Balanced (128 colors, compressed)',
        "popup_gif_opt_quality": 'High quality (256 colors)',
        "popup_gif_opt_extreme": 'Extreme compression (32 colors, micro size)',
        "popup_gif_fps": 'Framerate (FPS):',
        "popup_gif_start": 'Start GIF Recording',
